package com.haleem.customerpools.jsf;

import com.haleem.customerpools.entity.Customer;
import com.haleem.customerpools.entity.Department;
import com.haleem.customerpools.entity.util.JsfUtil;
import com.haleem.customerpools.entity.util.JsfUtil.PersistAction;
import com.haleem.customerpools.service.CustomerServiceLocal;
import com.haleem.customerpools.service.DepartmentServiceLocal;
...
public class CustomerController implements Serializable {
    ...
    public List<Customer> getItems() {
        if (items == null) {
            items = customerServiceLocal.findAllCustomers();
        }
        return items;
    }
    ...
    public List<Department> getDepartments() {
        if (departments == null) {
            departments = departmentServiceLocal.findAllDepartments();
        }
        return departments;
    }
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction != PersistAction.DELETE) {
                    customerServiceLocal.editCustomer(selected);
                } else {
                    customerServiceLocal.deleteCustomer(selected);
                }
    ...
    public Customer getCustomer(java.lang.Integer id) {
        return customerServiceLocal.findById(id);
    }

    public List<Customer> getItemsAvailableSelectMany() {
        return customerServiceLocal.findAllCustomers();
    }
    ...
    public void onCellEdit(CellEditEvent event) {
        ...
        if (!oldValue.equals(newValue)) {
            ...
            customerServiceLocal.editCustomer(customer);
    ...
    public String loadCustomer() {
        ...
        selected = customerServiceLocal.findById(Integer.valueOf(customer));
        return "customerInfo";
    }
